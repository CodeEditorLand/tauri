...
`yarn`, and `bun`, this library provides a node.js runner for common tasks when
using Tauri, like `pnpm tauri dev`. For the most part it is a wrapper around
[tauri-cli](https://github.com/tauri-apps/tauri/blob/dev/crates/tauri-cli).
...
The preferred method is to install this module locally as a development
dependency:
