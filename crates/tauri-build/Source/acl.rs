...
fn read_plugins_manifests() -> Result<BTreeMap<String, Manifest>> {
	...
	let permission_map = acl::build::read_permissions()
		.context("failed to read plugin permissions")?;
	let mut global_scope_map = acl::build::read_global_scope_schemas()
