...
pub struct Options {
	...
	#[clap(short = 'k', long, conflicts_with("private_key_path"), env = "TAURI_PRIVATE_KEY")]
	private_key:Option<String>,
	/// Load the private key from a file
	#[clap(short = 'f', long, conflicts_with("private_key"), env = "TAURI_PRIVATE_KEY_PATH")]
...
pub fn command(mut options:Options) -> Result<()> {
	...
	println!(
		"\nYour file was signed successfully, You can find the signature here:\n{}\n\nPublic \
		 signature:\n{}\n\nMake sure to include this into the signature field of your update \
		 server.",
