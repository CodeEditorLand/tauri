...
enum Commands {
	/// Print the default Upgrade Code used by MSI installer derived from
	/// productName.
	WixUpgradeCode,
}
...
// NOTE: if this is ever changed, make sure to also update Wix upgrade code
// generation in tauri-bundler
