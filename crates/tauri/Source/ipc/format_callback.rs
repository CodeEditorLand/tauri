...
/// Formats a function name and a serializable argument to be evaluated as
/// callback.
///
...
/// Formats a function name and a raw JSON string argument to be evaluated as
/// callback.
///
...
mod test {
	...
	impl Arbitrary for CallbackFn {
		fn arbitrary(g:&mut Gen) -> CallbackFn { CallbackFn(u32::arbitrary(g)) }
	}
	...
	fn serialize_js<T:Serialize>(value:&T) -> crate::Result<String> {
		serialize_js_with(serde_json::to_string(value)?, Default::default(), |v| v.into())
	}
