...
fn has_feature(feature:&str) -> bool {
	...
	// when a feature is enabled, Cargo sets the `CARGO_FEATURE_<name>` env var
	// to 1 <https://doc.rust-lang.org/cargo/reference/environment-variables.html#environment-variables-cargo-sets-for-build-scripts>
