...
impl<R:Runtime> Clone for WebviewWindow<R> {
	fn clone(&self) -> Self { Self { webview:self.webview.clone() } }
}
...
impl<R:Runtime> WebviewWindow<R> {
	...
	pub fn menu(&self) -> Option<Menu<R>> { self.webview.window().menu() }
	...
	pub fn hide_menu(&self) -> crate::Result<()> { self.webview.window().hide_menu() }

	/// Shows the window menu.
	pub fn show_menu(&self) -> crate::Result<()> { self.webview.window().show_menu() }

	/// Shows the window menu.
	pub fn is_menu_visible(&self) -> crate::Result<bool> { self.webview.window().is_menu_visible() }
...
impl<R:Runtime> WebviewWindow<R> {
	...
	pub fn scale_factor(&self) -> crate::Result<f64> { self.webview.window().scale_factor() }
	...
	pub fn is_fullscreen(&self) -> crate::Result<bool> { self.webview.window().is_fullscreen() }

	/// Gets the window's current minimized state.
	pub fn is_minimized(&self) -> crate::Result<bool> { self.webview.window().is_minimized() }

	/// Gets the window's current maximized state.
	pub fn is_maximized(&self) -> crate::Result<bool> { self.webview.window().is_maximized() }

	/// Gets the window's current focus state.
	pub fn is_focused(&self) -> crate::Result<bool> { self.webview.window().is_focused() }

	/// Gets the window's current decoration state.
	pub fn is_decorated(&self) -> crate::Result<bool> { self.webview.window().is_decorated() }

	/// Gets the window's current resizable state.
	pub fn is_resizable(&self) -> crate::Result<bool> { self.webview.window().is_resizable() }
	...
	///
	/// - **Linux / iOS / Android:** Unsupported.
	pub fn is_maximizable(&self) -> crate::Result<bool> { self.webview.window().is_maximizable() }
	...
	///
	/// - **Linux / iOS / Android:** Unsupported.
	pub fn is_minimizable(&self) -> crate::Result<bool> { self.webview.window().is_minimizable() }
	...
	///
	/// - **Linux / iOS / Android:** Unsupported.
	pub fn is_closable(&self) -> crate::Result<bool> { self.webview.window().is_closable() }

	/// Gets the window's current visibility state.
	pub fn is_visible(&self) -> crate::Result<bool> { self.webview.window().is_visible() }

	/// Gets the window's current title.
	pub fn title(&self) -> crate::Result<String> { self.webview.window().title() }
	...
	/// Returns the native handle that is used by this window.
	#[cfg(windows)]
	pub fn hwnd(&self) -> crate::Result<HWND> { self.webview.window().hwnd() }
	...
	pub fn default_vbox(&self) -> crate::Result<gtk::Box> { self.webview.window().default_vbox() }
	...
	///
	/// - **macOS**: Only supported on macOS 10.14+.
	pub fn theme(&self) -> crate::Result<crate::Theme> { self.webview.window().theme() }
}
...
impl<R:Runtime> WebviewWindow<R> {
	/// Centers the window.
	pub fn center(&self) -> crate::Result<()> { self.webview.window().center() }
	...
	pub fn maximize(&self) -> crate::Result<()> { self.webview.window().maximize() }

	/// Un-maximizes this window.
	pub fn unmaximize(&self) -> crate::Result<()> { self.webview.window().unmaximize() }

	/// Minimizes this window.
	pub fn minimize(&self) -> crate::Result<()> { self.webview.window().minimize() }

	/// Un-minimizes this window.
	pub fn unminimize(&self) -> crate::Result<()> { self.webview.window().unminimize() }

	/// Show this window.
	pub fn show(&self) -> crate::Result<()> { self.webview.window().show() }

	/// Hide this window.
	pub fn hide(&self) -> crate::Result<()> { self.webview.window().hide() }
	...
	pub fn close(&self) -> crate::Result<()> { self.webview.window().close() }

	/// Destroys this window. Similar to [`Self::close`] but does not emit any
	/// events and force close the window instead.
	pub fn destroy(&self) -> crate::Result<()> { self.webview.window().destroy() }
	...
	pub fn set_visible_on_all_workspaces(
		...
		self.webview.window().set_visible_on_all_workspaces(visible_on_all_workspaces)
	}
	...
	pub fn set_focus(&self) -> crate::Result<()> { self.webview.window().set_focus() }
	...
	pub fn start_dragging(&self) -> crate::Result<()> { self.webview.window().start_dragging() }
